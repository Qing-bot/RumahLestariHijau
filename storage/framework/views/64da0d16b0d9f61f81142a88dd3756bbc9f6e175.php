...
<!-- Promo End -->
    ...
    <div id="carousel" style="margin-top: -10%; margin-bottom: 8%">
        ...
        <div class="slidePromo"><a href="#"><img src="<?php echo e(Storage::url($promo->photo)); ?>" class="homeImage"></a></div>
    ...
    <div style="display: flex; text-align: justify; justify-content: center;">
        <div style="padding: 5%">
            ...
            <div style="text-align:center; width: 50vh;">
                <img src="<?php echo e(Storage::url($hs->photo)); ?>" style="width: 100%;">
