...
<?php $__env->startSection('title', 'Edit Souvenir - Rumah Hijau'); ?>
...
<?php if(Auth::check()): ?>
<form method='POST' enctype="multipart/form-data" action="<?php echo e(route('edits', $data->id)); ?>">
    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <button type="submit" class="btn btn-primary"><?php echo e(__('Edit Souvenir')); ?></button>
    <?php endif; ?>
</form>
...
<?php echo $__env->make('template.admintemplate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Downloads\Binus\RumahLestariHijau\resources\views/admin/editSouvenir.blade.php ENDPATH**/ ?>